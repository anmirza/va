...
export const productionCompanies: ProductionCompany[] = [
  ...
  },
  {
    ...
    city: 'Sydney',
    country: 'Australia',
    logo: 'https://via.placeholder.com/200x80?text=Revolver',
    coverImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',
    specialties: ['Live Action', 'Commercials', 'Film'],
    employees: 55,
    website: 'revolverfilm.com.au',
    description: 'Australia\'s leading independent production company.',
    about: 'Revolver is an award-winning Sydney-based production company known for bold storytelling and craft.',
    founded: 2000,
    clients: ['Carlton Draught', 'ANZ', 'Telstra', 'Qantas'],
  },
  {
    id: 'prod-08',
    name: 'AOI Pro',
    city: 'Tokyo',
    country: 'Japan',
    logo: 'https://via.placeholder.com/200x80?text=AOI+Pro',
    coverImage: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=800&q=80',
    specialties: ['Commercials', 'Film', 'Animation'],
    employees: 200,
    website: 'aoipro.com',
    description: 'Japan\'s premier commercial and film production company.',
    about: 'AOI Pro is one of Japan\'s largest and most respected production companies, creating award-winning work for global and domestic brands.',
    founded: 1963,
    clients: ['Toyota', 'Sony', 'Shiseido', 'Suntory'],
  },
  {
    id: 'prod-09',
    ...
    city: 'São Paulo',
    country: 'Brazil',
    logo: 'https://via.placeholder.com/200x80?text=Conspira%C3%A7%C3%A3o',
    coverImage: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=800&q=80',
    specialties: ['Commercials', 'Music Videos', 'Film', 'Live Action'],
    employees: 90,
    website: 'conspiracao.com.br',
    description: 'São Paulo-based production powerhouse with global reach.',
    about: 'Conspiração Filmes is Brazil\'s most decorated production company, known for culturally vibrant commercials and music videos.',
    founded: 1994,
    clients: ['Ambev', 'Bradesco', 'Volkswagen', 'Globo'],
  },
]
