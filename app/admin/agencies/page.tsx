    ...
    <div className="max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 mb-6 flex-wrap">
        <div>
          ...
          <p className="text-white/40 text-sm">Manage all registered advertising agencies.</p>
        </div>
      ...
      {filtered.length === 0 ? (
        <div className="glass-card rounded-2xl p-16 text-center">
          ...
          <p className="text-white/40 text-sm">{search ? 'No agencies match your search.' : 'No agencies registered yet.'}</p>
          <p className="text-white/20 text-xs mt-1 mb-4">Create one manually or approve a pending registration.</p>
          <Link href="/admin/agencies/create">
            <Button size="sm" className="bg-[#0763d8] hover:bg-[#0655b3] text-white rounded-xl">
