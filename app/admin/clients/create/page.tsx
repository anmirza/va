...
import { ArrowLeft, Building2, Globe, Coins, Info, Save, MapPin, Clock } from 'lucide-react'
...
export default function CreateClientCompanyPage() {
  ...
  const selectCls = 'w-full h-10 bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 text-sm text-white focus:outline-none focus:border-[#0763d8]/60'
    ...
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-white/40 text-sm mt-0.5">Register a new client company with hierarchy and token allocation.</p>
        </div>
      </div>
        ...
        <div className="glass-card rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/30 mt-0.5">Powered by Google Maps</p>
            </div>
          </div>
          <div>
            <label className="block text-xs font-medium text-white/50 mb-1.5 uppercase tracking-wider">
