  ...
  return (
    <div className="max-w-5xl">
      ...
      <p className="text-xs text-white/20 mt-4">
        ...
        {isSuperAdmin && <span className="ml-2 text-amber-400/50">Super admin: click <UserX className="inline w-3 h-3" /> to revoke / <UserCheck className="inline w-3 h-3" /> to restore access.</span>}
      </p>
    </div>
  )
}
