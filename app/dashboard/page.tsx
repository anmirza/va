...
import {
  Building2, Film, Settings, LayoutDashboard,
  Heart, Bookmark, ChevronRight, Lock, ArrowRight,
} from 'lucide-react'
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-[#0763d8] text-sm capitalize">Client Account</p>
                  {isFreeTier && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Link href="/directory" className="group glass-card p-5 flex items-start gap-4 hover:border-[#0763d8]/30 transition-all rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-white group-hover:text-[#0763d8] transition-colors">Browse Directory</p>
                      <p className="text-xs text-white/30 mt-0.5">Discover agencies and production houses</p>
                    </div>
                    <ChevronRight className="w-4 h-4 text-white/10 shrink-0 self-center group-hover:text-[#0763d8] transition-colors" />
                  </Link>

                  <Link href="/creative-library" className="group glass-card p-5 flex items-start gap-4 hover:border-[#0763d8]/30 transition-all rounded-xl">
                    <div className="w-10 h-10 bg-[#0763d8]/10 rounded-lg flex items-center justify-center shrink-0">
                      <Film className="w-5 h-5 text-[#0763d8]" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-white group-hover:text-[#0763d8] transition-colors">Creative Library</p>
                      <p className="text-xs text-white/30 mt-0.5">Explore award-winning campaigns</p>
                    </div>
                    <ChevronRight className="w-4 h-4 text-white/10 shrink-0 self-center group-hover:text-[#0763d8] transition-colors" />
                  </Link>

                  <Link href="/dashboard/settings" className="group glass-card p-5 flex items-start gap-4 hover:border-[#0763d8]/30 transition-all rounded-xl">
                    <div className="w-10 h-10 bg-[#0763d8]/10 rounded-lg flex items-center justify-center shrink-0">
                      <Settings className="w-5 h-5 text-[#0763d8]" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-white group-hover:text-[#0763d8] transition-colors">Account Settings</p>
                      <p className="text-xs text-white/30 mt-0.5">Manage your profile and preferences</p>
                    </div>
                    <ChevronRight className="w-4 h-4 text-white/10 shrink-0 self-center group-hover:text-[#0763d8] transition-colors" />
                  </Link>
                  ...
                  {isFreeTier ? (
                    ...
                    <Link href="/insights" className="group glass-card p-5 flex items-start gap-4 hover:border-[#0763d8]/30 transition-all rounded-xl">
                      <div className="w-10 h-10 bg-[#0763d8]/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                      <Bookmark className="w-5 h-5 text-[#0763d8]" /> Saved Campaigns
                    </h2>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {savedCampaigns.slice(0, 3).map(c => (
                      <Link key={c.id} href={`/campaigns/${c.id}`} className="group glass-card overflow-hidden hover:border-[#0763d8]/30 transition-all rounded-xl">
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                {followedAgencies.length > 0 ? (
                    ...
                    {followedAgencies.slice(0, 5).map(c => (
                      <Link key={c.id} href={`/directory/${c.id}`} className="flex items-center gap-3 group">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-medium text-white group-hover:text-[#0763d8] transition-colors truncate">{c.name}</p>
                  ...
                  <div className="text-center py-4">
                    <p className="text-sm text-white/30 mb-3">Not following any agencies yet</p>
                    <Link href="/directory">
                      <Button size="sm" className="bg-[#0763d8] hover:bg-[#0655b3] text-white text-xs rounded-full">
                        Discover Agencies
                      </Button>
                    </Link>
                  </div>
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                {isFreeTier ? (
                  <>
                    <p className="text-white/50 text-sm mb-1">You are on the <span className="text-white font-medium">Free</span> plan.</p>
                    <p className="text-white/30 text-xs mb-4">Upgrade to access full company profiles, governance data, financials, and more.</p>
                    <Link href="/pricing">
                  ...
                  <>
                    <p className="text-white/50 text-sm mb-4">You are on the <span className="text-[#0763d8] font-medium">Pro</span> plan.</p>
                    <Link href="/pricing">
                      <Button variant="outline" className="w-full border-white/[0.12] text-white/70 hover:text-white font-medium text-sm rounded-full">
                        Manage Subscription
                      </Button>
                    </Link>
                  </>
