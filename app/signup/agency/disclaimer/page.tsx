...
export default function AgencyDisclaimerPage() {
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-12">
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-10">
            <div className="w-16 h-16 rounded-2xl bg-[#0763d8]/10 border border-[#0763d8]/20 flex items-center justify-center mx-auto mb-5">
              <Building2 className="w-8 h-8 text-[#0763d8]" />
            </div>
            <p className="text-[#0763d8] text-sm font-medium uppercase tracking-widest mb-3">Agency Registration</p>
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 tracking-tight">
              Before You Begin
            </h1>
            <p className="text-white/50 text-sm sm:text-base max-w-md mx-auto">
              Please read the following information and legal disclaimer carefully before proceeding with your agency registration.
            </p>
          </div>
          ...
          <div className="glass-card rounded-2xl overflow-hidden mb-6">
            ...
            <div className="px-6 py-5 max-h-80 overflow-y-auto scrollbar-thin">
          ...
          <button
            ...
            className={`w-full flex items-start gap-4 p-5 rounded-2xl border transition-all duration-200 text-left mb-6 ${
              agreed
                ? 'bg-[#0763d8]/10 border-[#0763d8]/40 shadow-lg shadow-[#0763d8]/10'
                : 'bg-white/[0.03] border-white/[0.08] hover:border-white/20'
            }`}
          >
            <div className="mt-0.5 shrink-0">
              {agreed
                ? <CheckSquare className="w-5 h-5 text-[#0763d8]" />
          ...
          <Button
            ...
            disabled={!agreed}
            className="w-full h-12 bg-[#0763d8] hover:bg-[#0655b3] text-white rounded-xl font-medium flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
          >
