      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-lg text-center">
          ...
          <div className="relative w-24 h-24 mx-auto mb-8">
            <div className="absolute inset-0 rounded-full bg-[#0763d8]/20 animate-ping" style={{ animationDuration: '2s' }} />
            <div className="relative w-24 h-24 rounded-full bg-[#0763d8]/10 border-2 border-[#0763d8]/30 flex items-center justify-center">
              <Clock className="w-10 h-10 text-[#0763d8]" />
            </div>
          </div>
          ...
          <div className="glass-card p-8 rounded-2xl">
            ...
            <p className="text-white/60 text-sm sm:text-base leading-relaxed mb-8">
              Your agency registration is now <span className="text-amber-400 font-medium">under review</span>. Our team will carefully evaluate your application and get back to you shortly.
            </p>
            ...
            <div className="space-y-3 mb-8 text-left">
              {[
                ...
                { icon: Clock, label: 'Under review by VA team', done: true, color: 'text-[#0763d8]', current: true },
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                      step.current
                        ? 'bg-[#0763d8]/10 border border-[#0763d8]/20'
                        : step.done
                  ...
                  >
                    ...
                    {step.current && (
                      <span className="ml-auto text-xs bg-[#0763d8]/20 text-[#0763d8] px-2 py-0.5 rounded-full font-medium">
                        Current
                      </span>
                    )}
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/dashboard/vendor" className="flex-1">
                <Button className="w-full h-11 bg-[#0763d8] hover:bg-[#0655b3] text-white rounded-xl font-medium gap-2">
